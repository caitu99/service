 ...
 */
@Service
public class ManualUpdateSingleService{
	...
	private String MANUAL_UPDATE_ERR_MSG = "【自动更新失败】：manualId:{},userId:{},loginAccount:{},password:{},errMsg:{}";
	
	public void autoUpdateManual(List<ManualLogin> manualAccounts){
		String version = "2.2.1";
		logger.info("自动更新开始==================");
		for (ManualLogin manualLogin : manualAccounts) {
			try {
				logger.info("自动更新数据：userId:{},manualId:{},loginAccount:{}",manualLogin.getUserId(),manualLogin.getManualId()
						, manualLogin.getLoginAccount());
				...
				logger.warn(MANUAL_UPDATE_ERR_MSG,manualLogin.getManualId()
