 ...
 */
@Component
public class AutoFindYjf189 extends AutoFindImageAbstract{
...
//		return super.login(manualQueryYjf189, userId, loginAccount, password, count, "天翼");
		return null;
	}
	...
	public String loginForUpdate(Long userId,String loginAccount,String password){
		...
		String resultJson = super.loginForUpdate(manualQueryYjf189, userId, loginAccount, password);
		...
		if(ApiResultCode.IMAGECODE_ERROR == json.getInteger("code")){//验证码错误，再试一次
			resultJson = super.loginForUpdate(manualQueryYjf189, userId, loginAccount, password);
		}
		return resultJson;
	}
